...
(function($) {
    $.jQTouch = function(options) {
        ...
        var $body, 
            ...
            defaultAnimations=['slide','flip','slideup','swap','cubeleft','cuberight','cubeup','cubedown','pop','dissolve','fade','back'], 
            animations=[], 
            hairextensions='';
        ...
        function init(options) {
            ...
            var defaults = {
                ...
                cuberightSelector: '.cuberight',
                cubeupSelector: '.cubeup',
                cubedownSelector: '.cubedown',
